...
from paperfarm.agent_runtime import resolve_agent
...
from paperfarm.config import load_config, require_supported_protocol
from paperfarm.graph_protocol import (
    initialize_graph_runtime_state,
    resolve_role_agent_name,
)
from paperfarm.parallel_runtime import run_parallel_experiment_batch
from paperfarm.research_loop import (
    ResearchLoop,
)
from paperfarm.research_loop import (
...
from paperfarm.tui_runner import (
    print_exit_summary,
    run_tui_session,
    start_daemon,
)
from paperfarm.workflow_options import apply_worker_override
...
def do_run(
    ...
    if not research.is_dir():
        console.print("[red]Error:[/red] .research/ not found. Run 'PaperFarm init' first.")
        raise SystemExit(1)
