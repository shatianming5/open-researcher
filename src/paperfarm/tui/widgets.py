...
class StatsBar(Static):
    ...
    def render(self) -> str:
        return self.stats_text or "[bold]PaperFarm[/bold] [dim]booting command center...[/dim]"
    ...
    def update_stats(self, state: dict, phase: str = "", paused: bool = False) -> None:
        ...
        parts.append(f"[bold {C_TEXT}]PAPERFARM[/]")
...
class SessionChromeBar(Static):
    ...
    def update_chrome(self, chrome: SessionChrome) -> None:
        ...
        lines = [
            f"[bold {C_TEXT}]PaperFarm Command Center[/]  {phase_line}  {control_suffix}",
            config_line,
            metric_line,
            volume_line,
        ]
