...
from paperfarm.tui.modals import GPUStatusModal, LogScreen
from paperfarm.tui.view_model import DashboardState, build_dashboard_state, build_docs_workbench
