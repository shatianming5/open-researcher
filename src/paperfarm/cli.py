"""PaperFarm CLI — research workflow framework for AI agents."""
...
from paperfarm.bootstrap import format_bootstrap_dry_run
from paperfarm.config import ResearchConfig, load_config
from paperfarm.config_cmd import config_app
from paperfarm.ideas_cmd import ideas_app
from paperfarm.logs_cmd import logs_app
...
app = typer.Typer(
    name="PaperFarm",
    help="PaperFarm research workflow framework for AI agents. Legacy CLI alias: `open-researcher`.",
)
...
def _dispatch_workflow(
    *,
    ...
    if use_bootstrap_flow:
        ...
        from paperfarm.run_cmd import do_start
...
def status(
    ...
    from paperfarm.status_cmd import print_status
...
def results(
    ...
    from paperfarm.results_cmd import print_results, print_results_chart, print_results_json
...
def export():
    ...
    from paperfarm.export_cmd import do_export
...
def doctor():
    ...
    from paperfarm.doctor_cmd import print_doctor
